...
class User(db.Model):
    __tablename__ = 'User'
    __table_args__ = {"useexisting":True}  #如果表已建立，则追加信息
    ...
    userlogs = dbrelationship('Userlog',backref='user')
    comments = db.Column('Commnet',backref='user')
    moviecols = db.Column('Moviecol',ckref='user')
